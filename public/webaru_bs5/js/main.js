...
/*------------------------------------------------
  ...
  --------------------- */
    ...
    if (window.addEventListener) {
        ...
        if (toTopEl && !toTopEl._vanillaScrollUp) {
            toTopEl._vanillaScrollUp = true;
...
/*----------------------------
    ...
    *************************/
    if ($.fn.tooltip) {
        ...
        var tooltipTriggers = document.querySelectorAll('[data-bs-toggle="tooltip"], [data-toggle="tooltip"]');
        Array.prototype.slice.call(tooltipTriggers).forEach(function (el) {
