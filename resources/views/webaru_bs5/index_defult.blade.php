...
<head>
    ...
    <title>Home page || Eduguide</title>
    ...
    <link rel="stylesheet" href="{{ url('webaru_bs5/css/bootstrap.min.css') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 hidden-sm hidden-xs">
                            <div class="menu-area f-right">
                                <nav>
                                    <ul>
                                        <li class="active coloumn-one"><a href="index.html">HOME <i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                            <ul>
                                        ...
                                        <li class="mega-parent"><a href="#">shortcode <i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                        ...
                                        <li class="coloumn-one"><a href="#">pages <i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                            <ul>
                                                <li><a href="about-us.html">about us</a></li>
...
mlaboris nisi ut aliquip ex ea commodo conseq</p>
                        ...
                        <div class="col-md-12 text-center">
                            <div class="footer-logo-address">
                                <div class="footer-logo">
                                    <a href="#"><img src="{{ url('webaru_bs5/images/logo/footer-logo.png') }}" alt="" ></a>
                                </div>
    ...
    <script src="{{ url('webaru_bs5/js/vendor/jquery-1.12.0.min.js') }}"></script>
    <!-- Bootstrap framework js -->
    <script src="{{ url('webaru_bs5/js/bootstrap.min.js') }}"></script>
    <!--  ajax-mail.js  -->
