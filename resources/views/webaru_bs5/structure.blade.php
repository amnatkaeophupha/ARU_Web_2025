        ...
        <div class="row">
            <div class="col-md-12 mt-50">
                <div class="section-title text-center">
                    <img src="{{url('webaru_bs5/aru_images/logo')}}/2025_aru_bg_white.jpg">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="aru-event-text-img">
                    <div class="aru-visual-inner">
                        <img src="{{url('webaru_bs5/aru_images/plans/structure-66-1.png')}}" class="img-thumbnail">
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="aru-event-text-img mb-30 text-center">
                    <div class="aru-visual-inner">
                        <img src="{{url('webaru_bs5/aru_images/plans/structure-administration-2568.jpg')}}" class="img-thumbnail">
                    </div>
                </div>
            </div>
