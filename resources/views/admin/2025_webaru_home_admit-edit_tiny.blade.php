                    ...
                    <form class="row g-3" method="POST" action="{{ url('admin/webaru-admit/update/'.$item->id) }}"style="font-family:'Chakra Petch', sans-serif;" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            ...
                            tinymce.init({
                                ...
                                // Try the most popular premium features until Jan 28, 2026:
                                'checklist', 'mediaembed', 'casechange', 'formatpainter', 'pageembed', 'a11ychecker', 'tinymcespellchecker', 'permanentpen', 'powerpaste', 'advtable', 'advcode', 'advtemplate', 'ai', 'uploadcare', 'mentions', 'tinycomments', 'tableofcontents', 'footnotes', 'mergetags', 'autocorrect', 'typography', 'inlinecss', 'markdown','importword', 'exportword', 'exportpdf','autoresize',
                                ],
                                ...
                                // ให้หน้าตาเข้ากับ Rocker (โทนเรียบๆ)
                                content_style: `
                                body {
                                ...
                                // ให้ฟอนต์ใน dropdown มี Chakra Petch (optional)
                                font_family_formats:
                                ...
                                // ถ้าอยากให้เริ่มต้นเป็น Chakra Petch เลย
                                // (content_style คุมอยู่แล้ว แต่อันนี้ช่วยให้ dropdown แสดง)
                                // font_family_default: 'Chakra Petch',

                                tinycomments_mode: 'embedded',
                                tinycomments_author: 'Amnat Kaeophupha',
                                mergetags_list: [
                                { value: 'Amnat', title: 'Kaeophupha' },
                                { value: 'phuphakaeo@gmail.com', title: 'Welcome' },
                                ],
                                ai_request: (request, respondWith) => respondWith.string(() => Promise.reject('See docs to implement AI Assistant')),
                                uploadcare_public_key: '56770089057eac1803be',
                            });
                            </script>
                            <textarea name="description" class="form-control" style="font-size: 14px;">
